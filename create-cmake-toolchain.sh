...
set(CMAKE_C_FLAGS "-w -fuse-ld=lld ${EXTRA_FLAGS}")
set(CMAKE_CXX_FLAGS "-w -fuse-ld=lld ${EXTRA_FLAGS}")
set(CMAKE_C_LINK_FLAGS "${EXTRA_FLAGS}")
set(CMAKE_CXX_LINK_FLAGS "${EXTRA_FLAGS}")
EOT
